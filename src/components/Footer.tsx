...
export default function FooterGlow() {
  return (
    <footer className="relative z-10 mt-8 w-full bg-black overflow-hidden pt-16 pb-8">
      <style jsx global>{`
        .glass {
      ...
      <div className="glass bg-rose-900 relative mx-auto flex max-w-6xl flex-col items-center gap-8 rounded-2xl px-6 py-10 md:flex-row md:items-start md:justify-between md:gap-12">
        <div className="flex flex-col items-center md:items-start">
          <a href="#" className="mb-4 flex items-center gap-2">
            ...
            <span className="bg-gradient-to-br from-rose-700 to-rose-500 bg-clip-text text-xl font-semibold tracking-tight text-transparent">
              Mvpblocks
            </span>
          </a>
