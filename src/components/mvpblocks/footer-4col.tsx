      ...
      <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
        <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-foreground/50 mt-6 flex flex-wrap wrap-break-word ">
             I’m a full-stack web developer passionate about building modern, scalable, and user-friendly applications. I specialize in React.js, Next.js, Javascript, TypeScript, Tailwind CSS, and Node.js, Express.js with hands-on experience in databases like MongoDB and Oracle.
            </p>
